      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/attractions" className="text-gray-400 hover:text-primary transition-colors flex items-center">
              ...
              <li>
                <Link to="/map" className="text-gray-400 hover:text-primary transition-colors flex items-center">
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-500">
            &copy; {currentYear} {t('footer.tourism')}. {t('footer.rights')}.
          </p>
          <div className="flex mt-4 md:mt-0">
            <a href="#" className="text-sm text-gray-500 hover:text-gray-400 mr-4">Privacy Policy</a>
